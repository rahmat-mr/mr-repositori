...
--
-- Host: 127.0.0.1
-- Generation Time: 04 Okt 2020 pada 05.13
...
(1, 'Home', 'tampilan_utama', 'fa fa-calendar-plus-o', 0),
(2, 'Data Santri', 'Siswa', 'fa fa-users', 0),
(3, 'Data Karyawan', 'karyawan', 'fa fa-user-circle', 0),
(12, 'Lihat Data Santri', 'Siswa/justview', 'fa fa-users', 0),
(13, 'Lihat Data Karyawan', 'Karyawan/justview', 'fa fa-user-circle', 0),
(14, 'Pengguna Sistem', 'user', 'fa fa-id-badge', 0),
(18, 'Menu', 'menu', 'fa fa-list', 0);
...
CREATE TABLE `tbl_karyawan` (
  `kodek` varchar(11) NOT NULL,
  `namak` varchar(40) NOT NULL,
...
INSERT INTO `tbl_karyawan` (`kodek`, `namak`, `alamat`, `jk`, `jabatan`, `pendidikan`, `hp`, `foto`) VALUES
('K001', 'Suryani', 'Pekanbaru', 'Perempuan', 'Ustazah', 'S1', '0892 9898 2222', 'nisa_sabyan.jpg');
...
CREATE TABLE `tbl_siswa` (
  ...
  `alamat` varchar(50) NOT NULL,
  `kelas` enum('TAHFIZ','TAHSIN') NOT NULL,
  `iuran` varchar(20) NOT NULL,
  `jadwal` varchar(15) NOT NULL,
  `hafalan` varchar(15) NOT NULL,
...
INSERT INTO `tbl_siswa` (`kode`, `nama`, `alamat`, `kelas`, `iuran`, `jadwal`, `hafalan`, `prestasi`, `tanggal_lahir`, `tempat_lahir`, `foto`) VALUES
('18SI1002', 'Rezha Septyan Ramandha', 'Lampung', 'TAHFIZ', '10.000', 'Kamis', '2', 'Lomba ', '1997-01-24', 'Lampung', 'rahmat1.jpg');
...
(1, 'Sistem Zulaykha', 'admin', '21232f297a57a5a743894a0e4a801fc3', 1, 'index.jpg');
