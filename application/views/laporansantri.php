        ...
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            <div class="box-header  with-border">
              <h4 style="text-align:center" ><b><font color="#000033" style="font:Geneva, Arial, Helvetica, sans-serif">Data Santri Rumah Tahfiz Qur'an Zulaykha </b></h4></font>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <!-- button add -->
            <?php
                echo anchor('siswa/add', '<button class="btn bg-navy ">Tambah Data</button>');
                echo anchor('dompdf', '<button class="btn btn-print">LAPORAN</button>');
