...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-mini"><b>R</b>AZ</span>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="tampilan_utama"><i class="fa fa-home"></i> Home</a></li>
        <li><a href="siswa"><i class="fa fa-user-circle"></i>Siswa</a></li>
		<li><a href="karyawan"><i class="fa fa-list"></i>Karyawan</a></li>
      </ol>
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 -  <a href="https://web.facebook.com/rahmat.copaj08">MUHAMMAD RAHMAT</a>.</strong>
  </footer>
