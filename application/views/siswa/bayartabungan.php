    ...
    <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-primary">
            ...
            <!-- form start -->
            <?php
                echo form_open_multipart('siswa/bayartabungan', 'role="form" class="form-horizontal"');
            ?>
                ...
                <div class="box-body">
				  ...
				  <div class="form-group">
	 			  ...
	 			  <div class="form-group">
                      <label class="col-sm-2 control-label"><span class="btn btn-success">Setor Tabungan</label>

                      <div class="col-sm-4">
                        <input type="text" name="tabungan2" class="form-control" placeholder="Masukkan Tabungan" autocomplete="off" required>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-1">
                        <button type="submit" name="submit" class="btn btn-primary btn-flat"> SETOR</button>
                      </div>
