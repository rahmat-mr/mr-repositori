...
<table>
    <tr>
	<td style="font-size: 24px"><img src="<?= base_url('uploads/kop/kop2.jpg') ?>" width="1086" height="190"  >       </td>
    </tr>
</table>
...
<p align="center" style="font-size: 29px"><b>
  ...
  <img src="<?= base_url('/uploads/'.$data->foto) ?>" width="149" height="196"></td>
</p>
  </b>  
  <table width="799" height="425" border="0" class="table table-bordered table-striped" style="margin-left:115px" >
						...
						<tr>
                            ...
                            <td style="font-size: 24px">:</td>
                            <td style="font-size: 24px"><?php $kode   = $this->uri->segment(3);
